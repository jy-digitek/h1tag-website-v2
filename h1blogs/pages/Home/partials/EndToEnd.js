import { Container, SimpleGrid, Box, Card, CardBody, Heading, Text, Stack, Button, CardFooter, Image } from "@chakra-ui/react"
            ...
            <SimpleGrid columns={[1, 3, 3]} spacing={10} >
                ...
                <Box >
                    <Card maxW='sm' align='center'>
                        ...
                        <Button variant='solid' bg='#dc3545' borderRadius={20} px={10}  color='white'>
                            Learn More
                            </Button>
