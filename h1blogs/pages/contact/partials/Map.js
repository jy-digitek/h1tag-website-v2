      ...
      <SimpleGrid spacing={4} columns={[1, 2]} px={[0, "15%"]}>
        ...
        <Box>
          <Card py={10}>
            ...
            <CardBody py={3}>
              <Text>
                E-557, 2nd Floor, Opp, Goyal sons, Near Ramphal Chawk, West
                Delhi, Dwarka, Sector-7, New Delhi-110077
              </Text>
              <Text py={1}>
                <Highlight
                  query="Call @"
            ...
            <CardFooter>
              <Button rounded={"full"} bg="#be1e2d" px={10} color="white">
                Get Direction
              </Button>
            </CardFooter>
          </Card>
