                            ...
                            <CardBody>
                                ...
                                <List>
                                    <ListItem display={"flex"}>
                                        <ImLocation2 />
                                        <Text pl={3}>
                                            D-44, Kanjhawala Rd, Budh Vihar
                                            Phase I, Krishan Vihar, Delhi,
                                            110086
                                        </Text>
                                    </ListItem>
                                    <ListItem display={"flex"}>
                                    ...
                                    <ListItem display={"flex"}>
                                        <ImEnvelop />
                                        <Text pl={4}>info@h1tags.com</Text>
                                    </ListItem>
                                </List>
                                <Button
                                    style={{
                                ...
                                <CardBody>
                                    <Stack mt="6" spacing="3">
                                        ...
                                        <Text>
                                            ...
                                            tropical spaces, baroque inspired
                                            spaces, earthy toned spaces and for
                                            people who love a chic design with a
