                        ...
                        {({ isExpanded }) => (
                            <>
                                ...
                                <AccordionPanel pb={4}>
                                    ...
                                    area at Pearls Omaxe Tower, FF 18, First
                        ...
                        {({ isExpanded }) => (
                            <>
                                ...
                                <AccordionPanel pb={4}>
                                    H1Tags is the top{" "}
                                    <strong>
                                        digital marketing institute in
                                        Pitampura,
                                    </strong>{" "}
                        ...
                        {({ isExpanded }) => (
                            <>
                                ...
                                <AccordionPanel pb={4}>
                                    ...
                                    H1Tags provides you with 100% job because we
                                    work with numerous organisations for job
                                    placements.
                                </AccordionPanel>
                            </>
                        )}
