...
export const ScholarshipProgram = () => {
  return (
    <Container maxW={"full"} bg="lightblue">
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"} px={10}>
            ...
            and marks, eliminating financial issues. We are the only Digital
            Marketing Training Institute in Delhi with a scholarship program
          </Text>
