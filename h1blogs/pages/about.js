            ...
            <Container maxW={"full"} p={0}>
                ...
                >
                    ...
                    <Box sx={{ padding: 10 }} px={[0, 20]}>
                        <Text px={[0, 20]}>
                            <strong>H1 Tags:</strong>An Institute of Digital
                            Marketing provides the Best Digital Marketing Course
                            in Delhi with training programs in a variety of
                            areas, such as SEO, PPC, Social Media Marketing,
                            Content Management, and more, allowing students to
                            learn the most current methods in the field of
                            Digital Marketing. With over 10+ years of experience
                            in Digital Marketing, our institute assists you in
                            achieving your objectives and entering the industry.
                            We have a team of Digital Marketing experts who have
                            years of knowledge in their field and are
                            well-experienced. Our team is dedicated to providing
                            the students with the best knowledge possible.
                        </Text>
                    </Box>
                </Box>
                ...
                >
                    <Box px={[0, 10]}>
                        ...
                        >
                            ...
                            <Box as="p" sx={{ mb: 2 }}>
                                We have the vision to expand our Institute's
                                branches all around India so we can train the
                                student to acquire the top Digital Marketing
                                skill which is essential for building their
                                future.
                            </Box>
                            <Box as="p" sx={{ mb: 2 }}>
                                Considering the demands of the professional
                                world, we aim to provide the Best Digital
                                Marketing Course with practical and theoretical
                                knowledge. Digital Marketing is a booming career
                                in India, which is expected to provide
                                significant growth to the IT sectors.
                            </Box>
                        </Box>
                    </Box>
                </SimpleGrid>
                ...
                <Box textAlign={"center"} my={10}>
                    ...
                    <Text px={[5, 10, 20]} color={"black"} fontSize={20}>
                        We are a Digital Marketing Agency-based Institute that
                        has strong partnerships with several IT companies.
                        Well-reputed and known organizations actively seek out
                        our students, as we provide on-site training.
                    </Text>
                    <SimpleGrid
                        columns={[1, 2, 4]}
                        py={10}
          ...
          <SimpleGrid columns={[1, 1, 2]} gap={0} my={10} alignItems={"center"}>
            ...
            <Container
                ...
                sx={{
                    ...
                    background: "rgb(2,0,36)",
                    background:
                        "linear-gradient(380deg, #101C32 63%, gray 63%)",
                }}
            >
                <SimpleGrid columns={[1, 1, 2]} px={[2, 10]}>
                    ...
                    <Box color={"white"}>
                        ...
                        <Text pT={10} pb={5}>
                            Our sole and complete mission is to teach the value
                            of Digital Marketing by utilizing and creating a
                            viable digital career path for you. We assist you in
                            providing an understanding of the section-wise
                            method so that you can comprehend the process at
                            your own pace and put extra efforts into the program
                            that you like.
                        </Text>
                        <Heading
                            fontSize={28}
                        ...
                        <Text>
                            Mr. Yuvraj Singh is an accomplished entrepreneur who
                            has made a name for himself in the world of digital
                            marketing. Born with an innate entrepreneurial
                            spirit, Yuvraj started his career by launching
                            several ventures, including H1 TAGS, which is now
                            recognized as the top Digital Marketing Institute in
                            Delhi NCR.
                        </Text>
                        <Text>
                            With a proven track record of developing and
                            directing high-impact digital marketing strategies,
                            Yuvraj is an expert in overseeing web strategy and
                            development, digital engagement, and consumer-facing
                            tools. He has a deep understanding of the latest
                            trends and best practices in digital marketing and
                            is skilled in guiding strategic relationships to
                            achieve company goals.
                        </Text>
                        <Text>
                            Under Yuvraj's leadership, H1 TAGS has become the
                            go-to destination for individuals and businesses
                            looking to improve their digital marketing skills.
                            The institute offers a comprehensive curriculum
                            covering all aspects of digital marketing, including
                            SEO, PPC advertising, social media marketing, email
                            marketing, content marketing, and more.
                        </Text>
                        <Text>
                            Yuvraj is highly regarded in the industry for his
                            exceptional leadership skills and his ability to
                            inspire and motivate his team. He is a strategic
                            thinker who is always looking for innovative ways to
                            improve the performance of his company and his
                            clients' businesses.
                        </Text>
                        <Text>
                            In addition to his work at H1 TAGS, Yuvraj is also
                            involved in several other ventures and is a
                            respected thought leader in the field of digital
                            marketing. He is known for his dynamic and engaging
                            speaking style and has been invited to speak at
                            various conferences and events.
                        </Text>
                        <Text>
                            Outside of work, Yuvraj is a fitness enthusiast who
                            enjoys playing sports and staying active. He is a
                            true entrepreneur at heart and is constantly looking
                            for new and exciting opportunities to make a
            ...
            <Container
                ...
                sx={{
                    ...
                    background: "rgb(2,0,36)",
                    background:
                        "linear-gradient(380deg,  gray 63%, #101C32 63%)",
                }}
                color={"white"}
            >
                {/* director portfolio starts here */}
              ...
              <Image src={"/Akshay.png"} w={"100%"} />
                ...
                <SimpleGrid columns={[1, 1, 2]} px={[2, 10]}>
                    <Box>
                        ...
                        <Text>
                            Akshay is a highly skilled digital marketer with
                            over 8 years of experience in the field. He is
                            currently working as the Vice President at JY
                            Technologies Consulting Pvt Ltd., where he oversees
                            the company's digital marketing strategies and
                            ensures that their online presence is optimized for
                            maximum impact.
                        </Text>
                        <Text>
                            Apart from his role at JY Technologies, Akshay is
                            also a co-founder of a H1 Tags Digital Marketing
                            institute where he is committed to providing
                            high-quality education and training to students and
                            professionals alike. He has developed a
                            comprehensive curriculum covering all aspects of
                            digital marketing, including SEO, PPC advertising,
                            social media marketing, email marketing, content
                            marketing, and more.
                        </Text>
                        <Text>
                            Akshay is known for his exceptional teaching skills
                            and his ability to make complex concepts easy to
                            understand. He has a passion for helping others
                            succeed in the fast-paced and ever-evolving world of
                            digital marketing.
                        </Text>
                        <Text>
                            In his role as the Vice President at JY
                            Technologies, Akshay is responsible for developing
                            and executing digital marketing strategies that
                            drive business growth. He is an expert in leveraging
                            various digital platforms and tools to help
                            companies reach their target audience and achieve
                            their marketing goals.
                        </Text>
                        <Text>
                            With his extensive experience and expertise in
                            digital marketing, Akshay is a thought leader in the
                            industry. He has published articles and spoken at
                            conferences on various topics related to digital
                            marketing, sharing his insights and knowledge with
                            others in the field.
                        </Text>
                        <Text>
                            Outside of work, Akshay enjoys traveling and
                            exploring new cultures. He is a dedicated
                            professional who is committed to helping individuals
                            and businesses succeed in the dynamic world of
                            digital marketing.
                        </Text>
                    </Box>
                    <Box
            ...
            <Container maxW={"full"}>
                ...
                <Grid templateColumns="repeat(6, 1fr)" gap={0}>
                    ...
                    <GridItem colSpan={[6, 3]} bg="#3950a1" color={"#fff"}>
                        <Box sx={{ p: 10 }}>
                            <Text lineHeight={2}>
                                H1 Tags -School of Digital Marketing and Web
                                Development is one of India's top Digital
                                Marketing institutions in Delhi-NCR. We studied
                                several entry-level marketing job openings and
                                designed our syllabus according to the market
                                demand for our students to get easy placements.
                                Companies hiring from H1 Tags include Amazon,
                                Axis Bank, Google, PC Solutions, DH IT
                                Solutions, Wipro, Accenture, Genpact, 360
                                Realtors, HCL, NVidia, Microsoft, HDFC Bank,
                            ...
                            <List>
                                ...
                                >
                                    <ListIcon
                                        ...
                                        mt={1}
                                    />
                                    We provide our students with counseling and
                                    professional and placement services
                                </ListItem>
                                <ListItem
                                    sx={{
                                        display: "flex",
                                ...
                                >
                                    <ListIcon
                                        ...
                                        mt={1}
                                    />
                                    Our work training program makes students
                                    easily adjust to the actual work culture.
                                </ListItem>
                                <ListItem
                                    sx={{
                                        display: "flex",
                                ...
                                >
                                    <ListIcon
                                        ...
                                        mt={1}
                                    />
                                    Our trainer provides follow-up sessions with
                                    each student separately so that they can
                                    clear every doubt.
                                </ListItem>
                                <ListItem
                                    sx={{
                                ...
                                >
                                    <ListIcon
                                        ...
                                        mt={1}
                                    />
                                    During training, these sessions include
                                    career counseling, resume preparation, and
                                    practice job interviews with proper reports.
                                    Our trainers focus on topics mostly asked
                                    during interviews.
                                </ListItem>
                            </List>
                        </Box>
