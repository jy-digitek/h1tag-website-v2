          ...
          <AccordionItem>
            {({ isExpanded }) => (
              <>
                ...
                <AccordionPanel pb={4}>
                  <strong> H1Tags Rohini</strong> is located in the hub of
                  educational institute area at D-44, Kanjhawala Rd, Budh Vihar
                  Phase-I Krishan Vihar, Delhi, 110086
                </AccordionPanel>
              </>
            )}
          </AccordionItem>
            ...
            {({ isExpanded }) => (
              <>
                <h3>
                  <AccordionButton>
                    <Box as="span" flex="1" textAlign="left">
                      Why choose H1Tags Institute in Rohini?
                    </Box>
                    {isExpanded ? (
                      <MinusIcon fontSize="12px" />
                    ) : (
                ...
                <AccordionPanel pb={4}>
                  H1Tags is the top{" "}
                  <strong>digital marketing institute in Rohini,</strong> and it
                  offers offline live sessions, so you may learn digital
          ...
          <AccordionItem>
            {({ isExpanded }) => (
              <>
                ...
                <AccordionPanel pb={4}>
                  The cost of a digital marketing course in Rohini is determined
                  by the training programme that you select.
                </AccordionPanel>
              </>
            )}
          </AccordionItem>
            ...
            {({ isExpanded }) => (
              <>
                <h3>
                  <AccordionButton>
                    <Box as="span" flex="1" textAlign="left">
                      What are the advantages of the Rohini digital marketing
                      programme?
                    </Box>
                    {isExpanded ? (
                      <MinusIcon fontSize="12px" />
                ...
                <AccordionPanel pb={4}>
                  ...
                  saturated with Digital Marketing job vacancies for the Rohini
                  Region.
                </AccordionPanel>
              </>
            )}
            ...
            {({ isExpanded }) => (
              <>
                ...
                <AccordionPanel pb={4}>
                  ...
                  course in Rohini. H1Tags provides you with 100% job because we
                  work with numerous organisations for job placements.
                </AccordionPanel>
              </>
            )}
          </AccordionItem>
            ...
            {({ isExpanded }) => (
              <>
                <h3>
                  <AccordionButton>
                    <Box as="span" flex="1" textAlign="left">
                      Why is H1Tags the Best Digital Marketing Institute in
                      Rohini?
                    </Box>
                    {isExpanded ? (
                      <MinusIcon fontSize="12px" />
                ...
                <AccordionPanel pb={4}>
                  Because we have an excellent combination of the newest digital
                  marketing technologies and approaches, H1Tags is Rohini's top
                  digital marketing institute. We provide you with a credential
                  and a live project to assist you in launching your digital
                  marketing career. During our more than nine years in this
                  industry, we have trained over 2000 students.
                  <br />
                  <br />
                  This is why{" "}
                  <strong>Rohini Marketing Institute in Rohini</strong> is
                  ranked #1 among the best digital marketing training
                  institutions by H1Tags.
                </AccordionPanel>
              </>
            )}
          </AccordionItem>
          ...
          <AccordionItem>
            {({ isExpanded }) => (
              <>
                ...
                <AccordionPanel pb={4}>
                  Enrolling in the top{" "}
                  <strong>Digital Marketing Institute in Rohini</strong>, which
                  also offers training and internship possibilities, is a great
                  way to enhance your career in digital marketing. Enroll in a
                  thorough digital marketing course offered by one of Rohini's
                  top digital marketing training centers to ride the digital
                  wave.
                </AccordionPanel>
              </>
            )}
