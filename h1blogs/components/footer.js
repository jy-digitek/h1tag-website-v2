            ...
            >
              ...
              About H1 Tags
                        ...
                        <Text fontSize={"12px"} py={3}>
                            <strong> H1 Tags:</strong> A School of Digital
                            Marketing provides the Best Digital Marketing Course
                            in Delhi with training programs allowing students to
                            learn the most current methods in the field of
                            Digital Marketing. With over a decade of experience
                    ...
                    <Box>
                        ...
                        <List spacing={3} fontSize="14px" py={3}>
                            <ListItem p={0}>
                                <Link href={"digitalmarketing.html"}>
                                    <ListIcon
                                        as={ChevronRightIcon}
                                        color="white"
                                    />
            ...
            Jaipur | Srinagar J&K
                    ...
                    <Box>
                        ...
                        <Flex pt={3}>
                            ...
                            <Box mr={5}>
                                <Link
                                    href={"https://www.instagram.com/h1tags/"}
                                >
                            ...
                            <Box mr={5}>
                                <Link
                                    href={
                                        "https://www.linkedin.com/company/h1tags/"
                                    }
                                >
