...
export const comparision = [
  {
    icon: <MdCurrencyRupee size={"100px"} />,
  ...
  {
    icon: <FaChalkboardTeacher size={"100px"} />,
  ...
  {
    icon: <BsFillHandbagFill size={"100px"} />,
    title: " Job Placement",
  ...
  {
    icon: <FaUserGraduate size={"100px"} />,
