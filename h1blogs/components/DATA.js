...
export const ReasonData = [
  ...
  },
  {
    ...
    href: "/paid-internship-course.html",
  },
  {
    // icon: <FcBullish />,
    title: "Flexible Batch Timing",
    href: "/flexible-batch-timing.html",
  },
  {
    // icon: <FcDepartment />,
    title: "Live Pratice Sessions",
    href: "/live-pratice-sessions.html",
  },
  {
    // icon: <FcGrid />,
    title: "Work Opportunities from Day",
    href: "/work-opportunities-day.html",
  },
  {
    // icon: <FcManager />,
    title: "Traning by Real Time Experts",
    href: "/traning-real-time-experts.html",
  },
];
...
export const InternshipCourese = [
  {
    ...
    title:
      "A four-month program that includes both training and an internship is known as a digital marketing course with internship.",
  },
  {
    heading: "Internship with live project",
    title:
      "For two months, you can work as an intern, complete a real-world project, and take the course to get experience in the workplace.",
  },
  {
    heading: "Experience certificate ",
    title:
      "After the program, we will also give you a validated internship certificate from H1tags. ",
  },
];
